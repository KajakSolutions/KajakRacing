...
function Leaderboard() {
    ...
    const getDriverName = (carId: number, isPlayer: boolean): string => {
        ...
        const aiNames = ["Max Speed", "Tornado", "Diesel", "Hot Wheel", "Lightning"];
        ...
        return (
            <section className="leaderboard">
                <div className="container">
                    ...
                    <button id="ReturnToMenu" onClick={handleReturnToMenu}>Powrot do menu</button>
                </div>
            </section>
        );
    }
            ...
            <div className="container">
                ...
                {sortedResults.map((result, index) => (
                    ...
                    >
                        ...
                        <p className="nick">{getDriverName(result.carId, result.isPlayer)}</p>
